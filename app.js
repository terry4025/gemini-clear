...
function removeWatermarkBlending(imageData, alphaMap, position) {
...
class WatermarkEngine {
    ...
    async removeWatermarkFromImage(img) {
        ...
        removeWatermarkBlending(imageData, alphaMap, position);
...
async function handleFiles(files) {
    ...
    UI.processingInfo.classList.remove('hidden');
